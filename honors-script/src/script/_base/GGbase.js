var GGbase =
{
    load(callback)
    {
        ...
        scriptArr.push(`${scriptHost}/src/script/api/api-table/api-userAddr.js?v=${scriptVersion}`);
        ...
        scriptArr.push(`${scriptHost}/src/script/model/model-table/MUserAddr.js?v=${scriptVersion}`);
