var GGbase =
{
    load(callback)
    {
        ...
        cssArr.push(`${scriptHost}/src/css/entity/entity.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-common.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MBank.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MGovAddr.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MSystemBoard.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MBankaccount.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MCls.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MClssettlehist.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MClspurchasehist.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MGrp.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MGrpfncLoss.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MGrpfncPurchase.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MGrpfncSponsorship.css?v=${scriptVersion}`);
        cssArr.push(`${scriptHost}/src/css/entity/entity-MSchedulebyweek.css?v=${scriptVersion}`);
