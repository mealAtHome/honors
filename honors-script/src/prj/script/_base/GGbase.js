var GGbase =
{
    load(callback)
    {
        ...
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-Grpformnglog.js?v=${scriptVersion}`);
        ...
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MGrpformnglog.js?v=${scriptVersion}`);
