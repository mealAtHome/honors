var GGbase =
{
    load(callback)
    {
        ...
        /* common  */ scriptArr.push(`${scriptHost}/src/common/script/model/model-ref/MAddrcode.js?v=${scriptVersion}`);
        ...
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/_base/GGC/GGC-clslineupb.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/_base/GGC/GGC-clspurchasehist.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/_base/GGC/GGC-clssettle.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/_base/GGC/GGC-clssettlehist.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/_base/GGC/GGC-date.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/_base/GGC/GGC-grp.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/_base/GGC/GGC-GrpMember.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/_base/GGC/GGC-GrpfncSponsorship.js?v=${scriptVersion}`);
        ...
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-addrcode.js?v=${scriptVersion}`);
        ...
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-clslineupa.js?v=${scriptVersion}`)
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-clslineupb.js?v=${scriptVersion}`)
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-clslineuptmpa.js?v=${scriptVersion}`)
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-clslineuptmpb.js?v=${scriptVersion}`)
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-clslineuptmpc.js?v=${scriptVersion}`)
        ...
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/Api.GrpfncLoss.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-GrpfncPurchase.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-GrpfncSponsorship.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-Grpfnca.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-Grpfnclog.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-grpmtaga.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/api/api-table/api-grpmtagb.js?v=${scriptVersion}`);
        ...
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MClslineupa.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MClslineupb.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MClslineuptmpa.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MClslineuptmpb.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MClslineuptmpc.js?v=${scriptVersion}`);
        ...
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MGrpfncLoss.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MGrpfncPurchase.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MGrpfncSponsorship.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MGrpfnca.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MGrpfnclog.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MGrpmtaga.js?v=${scriptVersion}`);
        /* project */ scriptArr.push(`${scriptHost}/src/prj/script/model/model-table/MGrpmtagb.js?v=${scriptVersion}`);
        ...
        /* common  */ cssArr.push(`${scriptHost}/src/common/css/common/css/common-checkbox.css?v=${scriptVersion}`);
        ...
        /* common  */ cssArr.push(`${scriptHost}/src/common/css/common/css/common-tabbar.css?v=${scriptVersion}`);
        /* common  */ cssArr.push(`${scriptHost}/src/common/css/common-event/common-event.css?v=${scriptVersion}`);
        /* common  */ cssArr.push(`${scriptHost}/src/common/css/model/css/MUser.css?v=${scriptVersion}`);
        ...
        /* project */ cssArr.push(`${scriptHost}/src/prj/css/entity/entity-MGrpfncLoss.css?v=${scriptVersion}`);
        /* project */ cssArr.push(`${scriptHost}/src/prj/css/entity/entity-MGrpfncPurchase.css?v=${scriptVersion}`);
