...
Navigation.getURL = function(str)
{
    ...
    switch(str)
    {
        ...
        case Navigation.Page.A12UserMainGrp                                : url = `${host}/app/A00-user/A12-UserMainGrp.html?${scriptVersion}`; break;
        case Navigation.Page.A13UserMainCls                                : url = `${host}/app/A00-user/A13-UserMainCls.html?${scriptVersion}`; break;
        case Navigation.Page.A14UserMainSettle                             : url = `${host}/app/A00-user/A14-UserMainSettle.html?${scriptVersion}`; break;
        case Navigation.Page.A15UserMainManage                             : url = `${host}/app/A00-user/A15-UserMainManage.html?${scriptVersion}`; break;
        case Navigation.Page.A81UserBankacctList                           : url = `${host}/app/A00-user/A81-UserBankacctList.html?${scriptVersion}`; break;
        case Navigation.Page.A82UserBankacctUpdate                         : url = `${host}/app/A00-user/A82-UserBankacctUpdate.html?${scriptVersion}`; break;
        case Navigation.Page.A1011ManagePhonePrivacy                       : url = `${host}/app/A10-userManage/A1011ManagePhonePrivacy.html?${scriptVersion}`; break;
        case Navigation.Page.B10ManagerChooseGrp                           : url = `${host}/app/B00-manager/B10-ManagerChooseGrp.html?${scriptVersion}`; break;
        case Navigation.Page.B11ManagerMainHome                            : url = `${host}/app/B00-manager/B11-ManagerMainHome.html?${scriptVersion}`; break;
        case Navigation.Page.B12ManagerMainClasses                         : url = `${host}/app/B00-manager/B12-ManagerMainClasses.html?${scriptVersion}`; break;
        ...
        case Navigation.Page.B1000GrpFinanceHome                           : url = `${host}/app/B10-grpfnc/B1000GrpFinanceHome.html?${scriptVersion}`; break;
        case Navigation.Page.B1010GrpFinanceCapitalList                    : url = `${host}/app/B10-grpfnc/B1010GrpFinanceCapitalList.html?${scriptVersion}`; break;
        case Navigation.Page.B1011GrpFinanceCapitalUpdate                  : url = `${host}/app/B10-grpfnc/B1011GrpFinanceCapitalUpdate.html?${scriptVersion}`; break;
        case Navigation.Page.B1020GrpFinanceSponsorList                    : url = `${host}/app/B10-grpfnc/B1020GrpFinanceSponsorList.html?${scriptVersion}`; break;
        case Navigation.Page.B1021GrpFinanceSponsorUpdate                  : url = `${host}/app/B10-grpfnc/B1021GrpFinanceSponsorUpdate.html?${scriptVersion}`; break;
        case Navigation.Page.B1030GrpFinancePurchaseList                   : url = `${host}/app/B10-grpfnc/B1030GrpFinancePurchaseList.html?${scriptVersion}`; break;
        case Navigation.Page.B1031GrpFinancePurchaseUpdate                 : url = `${host}/app/B10-grpfnc/B1031GrpFinancePurchaseUpdate.html?${scriptVersion}`; break;
        case Navigation.Page.B1040GrpFinanceLossList                       : url = `${host}/app/B10-grpfnc/B1040GrpFinanceLossList.html?${scriptVersion}`; break;
        case Navigation.Page.B1041GrpFinanceLossUpdate                     : url = `${host}/app/B10-grpfnc/B1041GrpFinanceLossUpdate.html?${scriptVersion}`; break;
        case Navigation.Page.C00AdminChooseUser                            : url = `${host}/app/C00-admin/C00-AdminChooseUser.html?${scriptVersion}`; break;
        case Navigation.Page.D10DetailGrp                                  : url = `${host}/app/D00-detail/D10-DetailGrp.html?${scriptVersion}`; break;
        case Navigation.Page.D21DetailClssettle                            : url = `${host}/app/D00-detail/D21DetailClssettle.html?${scriptVersion}`; break;
        case Navigation.Page.D22DetailClssettleByClsno                     : url = `${host}/app/D00-detail/D22-DetailClssettleByClsno.html?${scriptVersion}`; break;
        case Navigation.Page.F00Class000Detail                             : url = `${host}/app/F00-class/F00-Class000Detail.html?${scriptVersion}`; break;
        case Navigation.Page.F00Class001DetailApplyDialog                  : url = `${host}/app/F00-class/F00-Class001DetailApplyDialog.html?${scriptVersion}`; break;
        case Navigation.Page.F00Class080TextCls                            : url = `${host}/app/F00-class/F00-Class080TextCls.html?${scriptVersion}`; break;
        case Navigation.Page.F00Class081TextApply                          : url = `${host}/app/F00-class/F00-Class081TextApply.html?${scriptVersion}`; break;
        case Navigation.Page.F00Class082TextSettle                         : url = `${host}/app/F00-class/F00-Class082TextSettle.html?${scriptVersion}`; break;
        case Navigation.Page.F10ClassUpdate000Default                      : url = `${host}/app/F00-class/F10-ClassUpdate000Default.html?${scriptVersion}`; break;
        case Navigation.Page.F10ClassUpdate010LineupUpdate                 : url = `${host}/app/F00-class/F10-ClassUpdate010LineupUpdate.html?${scriptVersion}`; break;
        case Navigation.Page.F10ClassUpdate011Lineuptmp                    : url = `${host}/app/F00-class/F10-ClassUpdate011Lineuptmp.html?${scriptVersion}`; break;
        case Navigation.Page.F10ClassUpdate020SettleEdit                   : url = `${host}/app/F00-class/F10-ClassUpdate020SettleEdit.html?${scriptVersion}`; break;
        case Navigation.Page.F10ClassUpdate021SettleSend                   : url = `${host}/app/F00-class/F10-ClassUpdate021SettleSend.html?${scriptVersion}`; break;
        case Navigation.Page.F10ClassUpdate026Purchase                     : url = `${host}/app/F00-class/F10-ClassUpdate026Purchase.html?${scriptVersion}`; break;
        case Navigation.Page.F10ClassUpdate030Cancel                       : url = `${host}/app/F00-class/F10-ClassUpdate030Cancel.html?${scriptVersion}`; break;
        case Navigation.Page.G10ScheduleByYear                             : url = `${host}/app/G00-schedule/G10ScheduleByYear.html?${scriptVersion}`; break;
        case Navigation.Page.G20ScheduleByWeek                             : url = `${host}/app/G00-schedule/G20ScheduleByWeek.html?${scriptVersion}`; break;
        case Navigation.Page.S10ChooseGrpMember                            : url = `${host}/app/S00-common/S10-ChooseGrpMember.html?${scriptVersion}`; break;
        case Navigation.Page.S11ChooseCls                                  : url = `${host}/app/S00-common/S11-ChooseCls.html?${scriptVersion}`; break;
        case Navigation.Page.Z00AppUpdateUrl                               : url = `${host}/app/Z00-system/Z00-AppUpdateUrl.html?${scriptVersion}`; break;
        case Navigation.Page.Z21SystemBoardList                            : url = `${host}/app/Z00-system/Z21-SystemBoardList.html?${scriptVersion}`; break;
        case Navigation.Page.Z22SystemBoardDetail                          : url = `${host}/app/Z00-system/Z22-SystemBoardDetail.html?${scriptVersion}`; break;
    }
    return url;
};
