Api.Cls =
{
    ...
    updateClsSettleInfoByPk       (grpno, clsno, arr1, arr2      , noticeOK, noticeFail) { return Api.Cls.update({ OPTION: "updateClsSettleInfoByPk"   , GRPNO:grpno, CLSNO:clsno, ARR1:arr1, ARR2:arr2, }, noticeOK, noticeFail); },
