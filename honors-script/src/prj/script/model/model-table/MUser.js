            ...
            `
                <div class="MUser-make-div-modelTop common-div-card">
                    ...
                    <span class="common-block common-fonts09">
                        ${model.getPhone()         != "" ? `<span class="common-block common-colorGy12 commonEvent-tag-phoneCall" phone-call="${model.getPhone()}">${model.getPhone()}</span>` : ""}
                        ${model.getHascarflgCvrt() != "" ? `<span class="common-block common-colorGy12">${model.getHascarflgCvrt()}</span>` : ""}
                    </span>
                </div>
            `;
        }
