        ...
        for(let i in this.getModels())
        {
            ...
            `
                <div class="MGrpMembers-make-div-modelTop common-div-card">
                    ...
                    <span class="common-block common-colorGray common-fonts08">${model.getClsPeriod()}</span>
                    <span class="common-block common-alignR common-bold">${model.getBillfinalWon()}</span>
                    <span class="common-block common-alignR common-colorGray common-fonts08">기준금액:${model.getBillstandardWon()}</span>
                    <span class="common-block common-alignR common-colorGray common-fonts08">사전정산:${model.getBillprepaidWon()}</span>
                    <span class="common-block common-alignR common-colorGray common-fonts08">청구추가:${model.getBilladjustmentWon()}</span>
                    <span class="common-block common-alignR common-colorGray common-fonts08">청구차감:${model.getBilldiscountWon()}</span>
                    ${model.getBillpointed() >= 1  ? `<span class="common-block common-alignR common-colorGray common-fonts08">사전정산:${model.getBillpointedWon()}</span>` : ""}
                    ${model.getBillmemo()    != "" ? `<span class="common-block common-alignR common-colorGray common-fonts08">보정사유:${model.getBillmemo()}</span>` : ""}
