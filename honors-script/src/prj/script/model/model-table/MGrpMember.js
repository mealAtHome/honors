        ...
        `
            <div class="MGrpMembers-make-div-modelTop common-div-card">
                ...
                <span class="common-block common-fonts09">
                    ${mUser.getPhone()         != "" ? `<span class="common-block common-colorGy12 commonEvent-tag-phoneCall" phone-call="${mUser.getPhone()}">${mUser.getPhone()}</span>` : ""}
                    ${mUser.getAddress()       != "" ? `<span class="common-block common-colorGy12">${mUser.getAddress()}</span>` : ""}
                    ${mUser.getHascarflgCvrt() != "" ? `<span class="common-block common-colorGy12">${mUser.getHascarflgCvrt()}</span>` : ""}
                </span>
                ${buttonHtmlFinal}
            </div>
        `;
